...
set  -e
 ...
 tar -czvf k8s-offline-master.tar.gz Readme.md     clear-k8s.sh     yaml   docker-install.sh   images/master    \
 ...
 tar -czvf k8s-offline-work.tar.gz Readme.md      clear-k8s.sh      yaml  docker-install.sh   images/work   \
